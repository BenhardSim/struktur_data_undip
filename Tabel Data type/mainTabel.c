...
int main(){
	...
	printf("\n\nMasukkan nilai yang ingin di hapus pada tabel kedua (hanya dapat menghapus satu nilai walau bernilai sama) : ");
	scanf("%d",&X5);
	delX(&A,X5);
	printf("\nElemen terisi dari tabel kedua setelah nilai %d di hapus: ",X5);
	viewTable(A);
	
	/*Menghapus elemeen dalam tabel pertama*/
	printf("\n\nMasukkan nilai yang ingin di hapus pada tabel pertama(menghapus semua nilai yang di piluh) : ");
	scanf("%d",&X3);
	delAllX(&P,X3);
